...
class RobertaForMaskFineTuning(RobertaModel):
    ...
    def __init__(self, config):
        super(RobertaForMaskFineTuning, self).__init__(config)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
        ...
        # sequence_output, pooled_output = self.bert(input_ids, attention_mask)[:2]
        sequence_output, pooled_output = self.roberta(input_ids, attention_mask)[:2]
