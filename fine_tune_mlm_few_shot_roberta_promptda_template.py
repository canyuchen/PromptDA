...
class Sst5Processor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġgreat", "Ġbrilliant", "Ġfantastic",\
                                 "Ġextraordinary", "Ġremarkable", "Ġfascinating",\
                                 "Ġenough", "Ġterrible", "Ġfunny",\
                                 "Ġawful", "Ġbad", "Ġworse",\
                                 "Ġboring", "Ġdone", "Ġunnecessary"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġgood", "Ġexcellent", "Ġunforgettable",\
                                 "Ġhilarious", "Ġinevitable", "Ġfunny",\
                                 "Ġdifferent", "Ġtime", "Ġinteresting",\
                                 "Ġpredictable", "Ġbad", "Ġover",\
                                 "Ġdreadful", "Ġboring", "Ġhorrible"
                                 ]
        elif self.data_seed == 42:
            self.label_words =  ["Ġmagnificent", "Ġunforgettable", "Ġfantastic",\
                                 "Ġrefreshing", "Ġremarkable", "Ġsublime",\
                                 "Ġhilarious", "Ġbad", "Ġdisappointing",\
                                 "Ġneither", "Ġpredictable", "Ġinevitable",\
                                 "Ġdepressing", "Ġpathetic", "Ġunnecessary"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġwonderful", "Ġfantastic", "Ġincredible",\
                                 "Ġterrifying", "Ġrefreshing", "Ġinteresting",\
                                 "Ġhilarious", "Ġdone", "Ġeasy",\
                                 "Ġbetter", "Ġdisappointing", "Ġpredictable",\
                                 "Ġdisgusting", "Ġridiculous", "Ġhorrible"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġmagnificent", "Ġexcellent", "Ġtoo",\
                                 "Ġstunning", "Ġunexpected", "Ġrefreshing",\
                                 "Ġsimple", "Ġdone", "Ġinteresting",\
                                 "Ġboring", "Ġthere", "Ġworse",\
                                 "Ġridiculous", "Ġsad", "Ġweird"]
...
class MrProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġexcellent", "Ġrefreshing", "Ġamazing", "Ġterrible", "Ġwrong", "Ġbad"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġrefreshing", "Ġgood", "Ġbeautiful", "Ġnot", "Ġterrible", "Ġdisappointing"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġbeautiful", "Ġperfect", "Ġfantastic", "Ġawful", "Ġdisappointing", "Ġhorrible"]
        elif self.data_seed == 42:
            self.label_words =  ["Ġfantastic", "Ġwonderful", "Ġbeautiful", "Ġterrible", "Ġawful", "Ġfunny"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġfantastic", "Ġincredible", "Ġunforgettable", "Ġterrible", "Ġfunny", "Ġbad"]
...
class CrProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġamazing", "Ġgreat", "Ġawesome", "Ġterrible", "Ġawful", "Ġhorrible"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġamazing", "Ġfun", "Ġcool", "Ġdisappointing", "Ġfrustrating", "Ġbad"]
        elif self.data_seed == 21:
            self.label_words = ["Ġexcellent", "Ġfun", "Ġcheap", "Ġawful", "Ġhorrible", "Ġterrible"]
        elif self.data_seed == 42:
            self.label_words =  ["Ġfree", "Ġfun", "Ġcool", "Ġbad", "Ġpainful", "Ġuseless"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġfantastic", "Ġbrilliant", "Ġincredible", "Ġterrible", "Ġinevitable", "Ġuseless"]
...
class MpqaProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġdifferent", "Ġgood", "Ġamazing", "Ġwrong", "Ġbad", "Ġfunny"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġpossible", "Ġnecessary", "Ġadopted", "Ġwrong", "Ġbad", "Ġdark"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġobvious", "Ġawesome", "Ġfun", "Ġthen", "Ġdifficult", "Ġgone"]
        elif self.data_seed == 42:
            self.label_words =  ["Ġright", "Ġfun", "Ġdecided", "Ġreported", "Ġunfair", "Ġrejected"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġaccepted", "Ġgood", "Ġgreat", "Ġunavoidable", "Ġawful", "Ġbad"]
...
class SubjProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġdisturbing", "Ġterrifying", "Ġkey", "Ġbad", "Ġnot", "Ġnonsense"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġepic", "Ġlife", "ĠAmerica", "Ġmadness", "Ġnot", "Ġwrong"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġlife", "Ġhistory", "Ġsignificant", "Ġright", "Ġthat", "Ġgreat"]
        elif self.data_seed == 42:
            self.label_words =  ["Ġwhat", "Ġreal", "Ġinteresting", "Ġme", "Ġgood", "Ġgreat"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġfiction", "Ġinteresting", "ĠAmerica", "Ġwonderful", "Ġgreat", "Ġbrilliant"]
...
class ColaProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġhow", "Ġamazing", "Ġnormal", "Ġtrue", "Ġhim", "Ġme"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġit", "Ġwrong", "Ġcorrect", "Ġridiculous", "Ġnot", "Ġgood"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġdifferent", "Ġsad", "Ġinteresting", "Ġcomplicated", "Ġhilarious", "Ġscary"]
        elif self.data_seed == 42:
            self.label_words =  ["Ġwrong", "Ġinteresting", "Ġimportant", "Ġinsane", "Ġsad", "Ġcrazy"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġall", "Ġgood", "Ġimportant", "Ġbad", "Ġnew", "Ġimpossible"]
