...
class Sst2Processor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġgood", "Ġperfect", "Ġfantastic", "Ġterrible", "Ġawful", "Ġhilarious"]
...
class Sst5Processor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġgreat", "Ġperfect", "Ġexcellent",\
                                 "Ġgood", "Ġpretty", "Ġwonderful",\
                                 "Ġneutral", "Ġnormal", "Ġfine",\
                                 "Ġbad", "Ġworse", "Ġnot",\
                                 "Ġterrible", "Ġawful", "Ġridiculous"]
        elif self.data_seed == 87:
            self.label_words =  ["Ġgreat", "Ġperfect", "Ġexcellent",\
                                 "Ġgood", "Ġpretty", "Ġwonderful",\
                                 "Ġneutral", "Ġnormal", "Ġfine",\
...
class MrProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġpositive", "Ġgreat", "Ġgood", "Ġnegative", "Ġterrible", "Ġbad"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġpositive", "Ġgreat", "Ġgood", "Ġnegative", "Ġterrible", "Ġbad"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġpositive", "Ġgreat", "Ġgood", "Ġnegative", "Ġterrible", "Ġbad"]
...
class SubjProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġgood", "Ġneutral", "Ġfair", "Ġbad", "Ġemotional", "Ġpersonal"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġgood", "Ġneutral", "Ġfair", "Ġbad", "Ġemotional", "Ġpersonal"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġgood", "Ġneutral", "Ġfair", "Ġbad", "Ġemotional", "Ġpersonal"]
...
class ColaProcessor_mlm(DataProcessor):
    ...
    def __init__(self, args):
        ...
        if self.data_seed == 100:
            self.label_words =  ["Ġpositive", "Ġcorrect", "Ġgood", "Ġnegative", "Ġwrong", "Ġbad"]
        elif self.data_seed == 13:
            self.label_words =  ["Ġpositive", "Ġcorrect", "Ġgood", "Ġnegative", "Ġwrong", "Ġbad"]
        elif self.data_seed == 21:
            self.label_words =  ["Ġpositive", "Ġcorrect", "Ġgood", "Ġnegative", "Ġwrong", "Ġbad"]
